...
output_file_algo1 = "simulation_results/final_results.json"
...
line_styles = {
    "Bat Algorithm": "solid",
    "pso Algorithm": "dashed"
}
markers = {
    "Bat Algorithm": "o",  # Circle marker
    "pso Algorithm": "s"   # Square marker
}
...
for rate in unique_data_rates:
    for data_rates, uav_numbers, best_fitness_values, label in [
        (data_rates_algo1, uav_numbers_algo1, best_fitness_values_algo1, "Bat Algorithm"),
        (data_rates_algo2, uav_numbers_algo2, best_fitness_values_algo2, "pso Algorithm"),
    ]:
